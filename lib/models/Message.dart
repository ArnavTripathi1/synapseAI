...
class Message extends amplify_core.Model {
  ...
  const Message._internal({required this.id, required chatRoomID, required senderID, required content, required createdAt, isRead, updatedAt}): _chatRoomID = chatRoomID, _senderID = senderID, _content = content, _createdAt = createdAt, _isRead = isRead, _updatedAt = updatedAt;
  
  factory Message({String? id, required String chatRoomID, required String senderID, required String content, required amplify_core.TemporalDateTime createdAt, bool? isRead}) {
  ...
  Message copyWith({String? chatRoomID, String? senderID, String? content, amplify_core.TemporalDateTime? createdAt, bool? isRead}) {
    return Message._internal(
      id: id,
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'chatRoomID': _chatRoomID, 'senderID': _senderID, 'content': _content, 'createdAt': _createdAt?.format(), 'isRead': _isRead, 'updatedAt': _updatedAt?.format()
  };
  ...
  static var schema = amplify_core.Model.defineSchema(define: (amplify_core.ModelSchemaDefinition modelSchemaDefinition) {
    ...
    modelSchemaDefinition.indexes = [
      amplify_core.ModelIndex(fields: const ["chatRoomID", "createdAt"], name: "byChatRoom")
    ];
